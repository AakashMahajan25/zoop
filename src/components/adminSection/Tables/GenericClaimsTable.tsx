...
export interface GenericClaimsTableProps {
    rowData: ClaimData[];
    pageSize?: number;
...
const GenericClaimsTable: React.FC<GenericClaimsTableProps> = ({
    rowData,
    pageSize = 10,
    onRowClick,
    // onActionChange,
            ...
            {totalPages > 1 && (<div className="flex items-center justify-between px-6 py-4">
                ...
                <div className="flex items-center space-x-1">
                    ...
                    <button
                        ...
                        className={`px-3 py-1 rounded-md border ${currentPage === 0
...
export default GenericClaimsTable;
